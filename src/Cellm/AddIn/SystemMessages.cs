...
internal static class SystemMessages
{
    public static string SystemMessage(Provider provider, string model, DateTime now)
    {
        ...
        Your purpose is to provide accurate and concise responses to user prompts within Excel formulas.
        ...
        <output format>
            Your output will populate a single Excel cell. Match your response format to the user's request:
        ...
        Do not provide explanations, steps, or engage in conversation and NEVER include meta-commentary like "Here is the result:".
        If you are provided with an array-like output schema, this format applies to each value in the output array.
