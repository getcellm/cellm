...
internal class NativeTools(ISender sender)
{
    ...
    [Description("Required. The absolute path to the root directory to start the glob search from, e.g. C:\\Users\\John\\Documents")] string rootPath,
    [Description("Required. The list of glob patterns whose matches will be included in the result")] List<string> includePatterns,
    [Description("Optional. The list of glob patterns whose matches will be excluded from the result")] List<string>? excludePatterns,
    ...
    public async Task<FileReaderResponse> FileReaderRequest(
        [Description("Required. The absolute path to the file.")] string filePath,
        CancellationToken cancellationToken)
    {
