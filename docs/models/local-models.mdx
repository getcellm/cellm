...
On this page you will learn what to consider when choosing a model and how to run a model locally.

## Choosing a model
We split local models into three tiers based on their size and capabilities, balancing speed, intelligence, and world knowledge:
