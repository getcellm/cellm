...
| Recommended model | Gemma 3 4B IT QAT | Gemma 3n E4B | Mistral Small 3.2 |
...
In general, smaller models are faster and less intelligent, while larger models are slower and more intelligent. When using local models, it's important to find the right balance for your task, because speed impact your productivity and intelligence impact your results. You should try out different models and choose the smallest one that gives you good results.
...
<Tip>
  Large models are need to use the Internet Browser tool effectively.
</Tip>
