...
To use hosted models you need an API key. In this example, we will show you how to use the Mistral API in Cellm. Mistral has a generous free tier that let's you use 1000,000,000 tokens per month at a rate of 1 request per second.
