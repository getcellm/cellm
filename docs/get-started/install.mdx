...
<AccordionGroup>
  <Accordion icon="xmark" title="Uninstall Cellm">
    ...
    Excel will not load Cellm the next time you start it. 
  </Accordion>
  ...
  <Accordion icon="trash" title="Remove from list of Add-Ins (optional)">
    ...
    2. Restart Excel and go File > Options > Add-Ins. Excel will ask you if it should remove the `Cellm-AddIn64-packed.xll` entry from the list of add-ins.
    3. Click `Yes`.
  </Accordion>
</AccordionGroup>
