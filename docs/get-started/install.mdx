...
## Install
Now let's install Cellm itself:

1. Go to the [Github Release page](https://github.com/getcellm/cellm/releases) and download the latest `Cellm-AddIn-Release-x64.msi`
2. Run the installer
...
## Upgrade
When a new version of Cellm is released, upgrading is simple:

1. Download the latest installer from [Github Release page](https://github.com/getcellm/cellm/releases).
2. Run the installer
...
2. Select "Cellm" and click "Uninstall".
