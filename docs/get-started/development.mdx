...
To sign the installer, you need the Windows 10 SDK or Windows 11 SDK which includes the sign tool. Run the Visual Studio Installer and modify your Visual Studio installation to include one of these SDKs.
