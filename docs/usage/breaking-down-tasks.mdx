...
- "Open google.com and search for "AI". Which website is ranked #1? Use Playwright browser tools."

<Tip>
With Playwright MCP enabled, Cellm can fetch online data (e.g., scrape a website or retrieve live information) on behalf of the the model.
</Tip>
